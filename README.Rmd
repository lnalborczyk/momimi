...
We can also use the model to generate realistic data from known parameter values and then fit the model to these data to try recover the original parameter values.

```{r simulating2, eval = FALSE}
