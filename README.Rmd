...
The `momimi` package implements the "threshold modulation model" (TMM) and the "parallel inhibition model" (PIM) of motor inhibition during motor imagery and provides fitting and plotting utilities.
